...
class BillingInvoiceLine {
  const BillingInvoiceLine(
      ...
      this.equipmentId,
      this.equipment,
      this.productionAllocations = const []});
  final int lineNo;
  ...
  final List<Map<String, dynamic>> productionAllocations;
  factory BillingInvoiceLine.fromJson(Map<String, dynamic> json) =>
      BillingInvoiceLine(
          lineNo: _int(json['line_no']),
          description: '${json['description'] ?? ''}',
          sourceType: '${json['source_type'] ?? ''}',
          revenueAccountId: _int(json['revenue_account_id']),
          enteredAmount: _double(json['entered_amount'] ?? json['net_amount']),
          net: _double(json['net_amount']),
          vat: _double(json['vat_amount']),
          total: _double(json['gross_amount']),
          quantity: json['quantity'] == null ? null : _double(json['quantity']),
          unitName: json['unit_name']?.toString(),
          unitPrice:
              json['unit_price'] == null ? null : _double(json['unit_price']),
          projectId:
              json['project_id'] == null ? null : _int(json['project_id']),
          project: json['project_snapshot']?.toString(),
          equipmentId: json['mixer_id'] == null ? null : _int(json['mixer_id']),
          equipment: json['mixer_snapshot']?.toString(),
          productionAllocations:
              (json['production_allocations'] as List? ?? const [])
...
class BillingInvoiceDetail {
  ...
  factory BillingInvoiceDetail.fromJson(Map<String, dynamic> data) {
    ...
    return BillingInvoiceDetail(
        ...
        terms: '${json['terms_snapshot'] ?? json['payment_term'] ?? ''}',
        vatMode: '${json['vat_mode'] ?? 'NONE'}',
        vatTaxCodeId: json['vat_tax_code_id'] == null
            ? null
            : _int(json['vat_tax_code_id']),
        vatRate: json['vat_rate_snapshot']?.toString(),
        net: _double(json['net_amount']),
        vat: _double(json['vat_amount']),
        total: _double(json['total_amount']),
