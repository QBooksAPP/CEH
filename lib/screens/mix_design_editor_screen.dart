...
class _MixDesignEditorScreenState extends State<MixDesignEditorScreen> {
  ...
  Future<void> _editAdmixture([MixAdmixture? existing]) async {
    ...
    final dosage = TextEditingController(
      text: _initialNumber(existing?.dosageCcPer100Kg),
    );
              ...
              onPressed: () {
                ...
                Navigator.pop(
                  ...
                  MixAdmixture(
                    ...
                    name: name.text.trim(),
                    dosageCcPer100Kg: parsedDosage,
                    dilutionFactor: parsedDilution,
                    sortOrder: parsedSort == null || parsedSort < 1
                        ? 1
                        : parsedSort,
                    isActive: active,
                  ),
              ...
              child: ListView(
                ...
                children: [
                  ...
                  if (_mode == MixDesignMode.client)
                    ...
                    InputDecorator(
                      decoration: _decoration('Calculated Sand', suffix: 'kg'),
                      child: Text(
                        _balancedSand == null
                  ...
                  Row(
                    children: [
                      Expanded(child: _numberField(_graniteSg, 'Granite SG')),
                      const SizedBox(width: 10),
                      Expanded(
                        child: _numberField(
                          _airPercent,
                    ...
                    for (final admixture in _admixtures)
                      Card(
                        child: ListTile(
                          ...
                          subtitle: Text(
                            '${admixture.dosageCcPer100Kg.toStringAsFixed(2)} '
                            'cc/100 kg • dilution '
