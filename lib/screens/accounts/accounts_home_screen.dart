...
import 'accounts_wht_certificates_screen.dart';
...
class _AccountsHomeScreenState extends State<AccountsHomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final destinations = <_AccountsDestination>[
      ...
      _AccountsDestination(
          'Journals & Ledger',
          'General Journal, account activity and Trial Balance',
      ...
      _AccountsDestination(
          'WHT Certificates',
          'Track pending certificates and received evidence',
          Icons.description_outlined,
          WhtCertificatesScreen(session: session, api: widget.api)),
    ];
