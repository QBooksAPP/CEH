...
class TCPDF_STATIC {
     ...
     */
    protected static function getCurlDefaultOptions() {
        return [
     ...
     * @var array<int, bool|int|string> cURL options.
     */
    protected static function getCurlFixedOptions() {
        return [
	...
	* @since 5.9.121 (2011-09-28)
	...
	public static function url_exists($url) {
        ...
        $curlopts = array_replace($curlopts, self::getCurlDefaultOptions());
        $curlopts = array_replace($curlopts, K_CURLOPTS);
        $curlopts = array_replace($curlopts, self::getCurlFixedOptions());
