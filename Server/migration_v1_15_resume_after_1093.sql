...
SET @ceh_v115_tax_liabilities_parent_id := (
  SELECT id FROM qbook_accounts_chart WHERE code='2300' LIMIT 1
);
SET @ceh_v115_liabilities_parent_id := (
  SELECT id FROM qbook_accounts_chart WHERE code='2000' LIMIT 1
);

INSERT INTO qbook_accounts_chart(code,name,account_type,parent_id,is_postable)
VALUES('1150','WHT Receivable','ASSET',@ceh_v115_assets_parent_id,1)
ON DUPLICATE KEY UPDATE code=VALUES(code);

INSERT INTO qbook_accounts_chart(code,name,account_type,parent_id,is_postable)
VALUES('2310','Output VAT Payable','LIABILITY',@ceh_v115_tax_liabilities_parent_id,1)
ON DUPLICATE KEY UPDATE code=VALUES(code);
